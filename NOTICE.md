...
This addon (script.module.dvhdr) is licensed GPL-2.0-or-later as a whole.

The Dolby Vision RPU bitstream layout implemented in `lib/dvhdr/rpu.py` was
...
The HDR10+ (ST 2094-40) parser in `lib/dvhdr/hdr10plus.py` was written from
